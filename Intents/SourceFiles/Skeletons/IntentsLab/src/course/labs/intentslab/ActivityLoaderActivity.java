...
public class ActivityLoaderActivity extends Activity {
	...
	private void startExplicitActivation() {
		...
		// TODO - Create a new intent to launch the ExplicitlyLoadedActivity class
		 Intent explicintent = new Intent(ActivityLoaderActivity.this, ExplicitlyLoadedActivity.class);
		// TODO - Start an Activity using that intent and the request code defined above
		 startActivityForResult(explicintent,GET_TEXT_REQUEST_CODE);
...
//				data=getIntent(); 
				String neko = data.getStringExtra("miotesto");
				mUserTextView.setText(neko);	
			};
		};
