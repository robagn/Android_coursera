...
public class ToDoListAdapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		RelativeLayout itemLayout = (RelativeLayout) myInflater.inflate(R.layout.todo_item,null);//.inflate(R.layout.todo_item, null);
	//	itemLayout =(RelativeLayout) myInflater.inflate(R.layout.todo_item, parent, null);
		...
		statusView.setOnCheckedChangeListener(new OnCheckedChangeListener() {
			...
			}else{   toDoItem.setStatus(Status.DONE);
